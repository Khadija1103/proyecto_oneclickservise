...
window.cambiarEstado = function(idProducto) {
    ...
    if (confirm(`?? ¿Desea cambiar el estado del producto "${producto.nombre}"?\n\n` +
        ...
        Swal.fire({text: `? Producto "${producto.nombre}" ahora está ${producto.activo ? "Activo" : "Inactivo"}`, confirmButtonText: "Aceptar"});
        renderizarproductos();
    }
};
