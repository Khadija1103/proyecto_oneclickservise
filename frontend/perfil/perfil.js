    ...
    formulario.addEventListener("submit", async function (e) {
        ...
        try {
            ...
            if (respuesta.ok) {
                ...
                Swal.fire({text: "Perfil actualizado correctamente", confirmButtonText: "Aceptar"});

                cargarPerfil();

            } else {

                Swal.fire({text: "No se pudo actualizar el perfil.", confirmButtonText: "Aceptar"});
            ...
            Swal.fire({text: "Error de conexión con el servidor.", confirmButtonText: "Aceptar"});
