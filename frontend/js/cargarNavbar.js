...
function cargarNavbar() {
    ...
    .then(function (html) {
        ...
        //==============================================
        // CARGAR MODAL TRABAJA CON NOSOTROS
        //==============================================
...
//======================================================
// CARGAR MODAL TRABAJA
//======================================================

function cargarModalTrabaja(){

fetch("../trabaja-con-nosotros/trabaja.html")
...
.then(function(res){
    ...
    if(!res.ok){
        ...
        throw new Error(
            "Error cargando trabaja: " + res.status
        );
...
.then(function(html){
    ...
    var contenedor =
    document.getElementById("modalTrabajaContainer");
    ...
    if(contenedor){
        ...
        if(!document.getElementById("cssTrabaja")){
            ...
            css.id="cssTrabaja";
            css.rel="stylesheet";
            css.href="../trabaja-con-nosotros/trabaja.css";
        ...
        if(!document.getElementById("jsTrabaja")){

            var script =
            document.createElement("script");

            script.id="jsTrabaja";
            script.src="../trabaja-con-nosotros/trabaja.js";
        ...
        console.log(
            "✅ Modal Trabaja cargado con CSS y JS"
        );
        ...
        console.log(
            "❌ No existe modalTrabajaContainer"
        );
